...
class Test:
    ...
    def insert_test_data() -> None:
        ...
        Connection.cursor.executemany("INSERT INTO users VALUES (?,?,?,?,?,?)", users_data)
        ...
        Connection.cursor.executemany("INSERT INTO follows VALUES (?,?,?)", follows_data)

        # Insert sample data into the 'tweets' table
        tweets_data = [
            (1, 1, '2023-01-01', 'This is a tweet by User1', None),
            (2, 2, '2023-01-02', 'Another tweet by User2', None),
            (3, 3, '2023-01-03', 'Tweet from User3', 1),
        ]
        Connection.cursor.executemany("INSERT INTO tweets VALUES (?,?,?,?,?)", tweets_data)
        ...
        Connection.cursor.executemany("INSERT INTO retweets VALUES (?,?,?)", retweets_data)
        ...
        Connection.cursor.executemany("INSERT INTO lists VALUES (?,?)", lists_data)
        ...
        Connection.cursor.executemany("INSERT INTO includes VALUES (?,?)", includes_data)
